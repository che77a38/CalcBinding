此项目是对原项目[Alex141/CalcBinding: Advanced WPF Binding which supports expressions in Path property and other features (github.com)](https://github.com/Alex141/CalcBinding)添加了对.net6.0的版本支持
